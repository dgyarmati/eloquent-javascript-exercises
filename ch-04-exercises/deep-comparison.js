...
// TODO it works, but it's horrendous - cleanup, please!

console.log(deepEqual({here: {}, object: 2}, {here: {is: "an"}, object: 2})); // false
console.log(deepEqual({here: {is: "an"}, object: 2}, {here: {is: "an"}, object: 2})); // true
console.log(deepEqual({here: undefined, object: 2}, {here: undefined, object: 2})); // true
console.log(deepEqual({here: undefined, object: 2}, {here: null, object: 2})); // false
console.log(deepEqual({here: {is: ""}, object: 2}, {here: {is: "an"}, object: 2})); // false
console.log(deepEqual(2, {here: {is: "an"}, object: 2})); // false
console.log(deepEqual(2, 2)); // true
console.log(deepEqual(null, 2)); // false
console.log(deepEqual(null, {here: {is: "an"}, object: 2})); // false
